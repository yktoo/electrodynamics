...
2. Только таким механизмом можно объяснить тот *частный случай*, когда индуктируемая ЭДС какое-то время остаётся [постоянной](/eddy-electric-field).
