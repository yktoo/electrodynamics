...
Здесь *&alpha;* — доля от общей длины контура, которую составляет выделенный участок, а *I* — ток в контуре. Для всего контура *&alpha;* = 1 и соотношение (2) даёт равенство *Э = IR* — закон Ома для замкнутой цепи. Выделенный участок контура можно считать локальным «микрогенератором» с внутренним сопротивлением *r*. Падение потенциала Δ*&phi; = Ir* является *внутренним* падением напряжения в таком «генераторе». Внешнее напряжение на «клеммах» генератора равно *u = &epsilon;* &minus; Δ*&phi; = &epsilon; &minus; Ir*, что (с учетом (2)) даёт *u* = 0.
