...
и далее <big>*IR=&phi;<sub>1</sub>-&phi;<sub>2</sub>*</big>, что является… обычным *законом Ома для участка цепи*. Если этот участок замкнуть, то *&phi;*<sub>1</sub> = *&phi;*<sub>2</sub> и соотношение (3) дает *закон Ома для замкнутой цепи*.
...
Некоторые аргументы в пользу таких представлений дает анализ природы [электромагнитного излучения](/em-waves).
